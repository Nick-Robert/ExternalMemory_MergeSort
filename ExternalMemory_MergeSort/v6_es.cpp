...
THIS VERSION HAS VARIABLE CHUNK SIZES IN MEMORY (CALLED PORTIONS) AND UTILIZES ORIGAMI SORT AND ORIGAMI MERGE SORT WITH 1 BUCKET REFILL WITH NAIVE MEMORY PORTION SIZES
...
int external_sort::merge_sort()
{
    ...
    */
    ...
    if (num_chunks == 1) {
        ...
        DWORD vals_per_chunk = (this->merge_mem_avail / num_chunks) / sizeof(Itemtype);
        //}
        ...
        {
            tot_bytes_from_delta += /*(static_cast<unsigned long long>(i) + 1) * */delta * sizeof(Itemtype);
        }
