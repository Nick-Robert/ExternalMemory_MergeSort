...
//#endif
        ...
        Itemtype last_val = 0;
        /*printf("            output[0] = %u", *((Itemtype*)output));
        printf("            output[1] = %u", *((Itemtype*)output + 1));
        printf("            output[2] = %u", *((Itemtype*)output + 2));
        printf("            output[139924] = %u\n", *((Itemtype*)output + 139924));
        printf("            output[262143] = %u   ", *((Itemtype*)output + 262143));*/
#ifdef SORT_CHECK
